...
WARNING! A part of my customization was taken from this repo!
...
## 🦁 Brave!
> [!NOTE]
> If you use another browser, you can install only "Dark Reader" and "Stylus" without changing settings like on Brave browser.
